...
{
	$this->db->query("INSERT INTO jobs (category_id,job_title,company,description,location,location,salary,contactu,contacte)
		VALUES (:category_id,:job_title,:company,:description,:location,:location,:salary,:contactu,:contacte)
		");
